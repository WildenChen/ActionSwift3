...
class GameViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        play.name = "play"
        play.addEventListener(InteractiveEventType.TouchBegin.rawValue, spriteTouched)
        stage.addChild(play)
        let stop = Sprite()
        ...
        stop.name = "stop"
        stop.addEventListener(InteractiveEventType.TouchBegin.rawValue, spriteTouched)
        stage.addChild(stop)
        ...
        movieClip.addEventListener(InteractiveEventType.TouchBegin.rawValue, spriteTouched)
        movieClip.addEventListener(InteractiveEventType.TouchEnd.rawValue, spriteTouched)
